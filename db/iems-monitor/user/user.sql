...
(
  ...
  is_enabled               tinyint(3)                   default 1                 not null comment '用户是否启用。1启用，0未启用',
  is_locked                tinyint(3)                   default 0                 not null comment '是否锁定账户',
  is_ldap                  tinyint(3)                   default 0                 null comment '是否是LDAP来源。1是，0不是',
